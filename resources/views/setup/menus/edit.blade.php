<x-app-layout>
    ...
    <div class="card">
        <div class="card-body flex flex-col gap-6">
            ...
            <div class="card">
                <div class="card-body">
                <form method="POST" action="/menus/{{ $menu->id }}" class="flex flex-col gap-6">
                    @method('PUT')
                    @csrf
                    <div>
                        <label for="main_id"
                            ...
                            <select name="main_id" id="main_id" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 ">
                                ...
                                @foreach ($menu_induk as $mi)
                                    <option value="{{ $mi->id }}" {{ $menu->main_id == $mi->id ? 'selected' : '' }}>{{ $mi->name }}
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Nama Menu" aria-describedby="hs-input-helper-text" value="{{ old('name', $menu->name) }}">
                        @error('name')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                       ...
                       <textarea class="responsive-textarea" name="description" id="description">{{ old('description', $menu->description) }}</textarea>
                       @error('description')
                            <div class="text-red-500">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="orderno" name="orderno"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Order No" aria-describedby="hs-input-helper-text" value="{{ old('orderno', $menu->orderno) }}">
                        @error('orderno')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="link" name="link"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Link Href" aria-describedby="hs-input-helper-text" value="{{ old('link', $menu->link) }}">
                        @error('link')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="icon" name="icon"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Icon Menu" aria-describedby="hs-input-helper-text" value="{{ old('icon', $menu->icon) }}">
                        @error('icon')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
