                ...
                <form method="POST" action="/users" class="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Nama User" aria-describedby="hs-input-helper-text" value="{{ old('name') }}">
                        @error('name')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Username" aria-describedby="hs-input-helper-text" value="{{ old('username') }}">
                        @error('username')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Email" aria-describedby="hs-input-helper-text" value="{{ old('email') }}">
                        @error('email')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
                    ...
                    <div>
                        ...
                        <input type="password" id="password" name="password"
                            class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0 "
                            placeholder="Password" aria-describedby="hs-input-helper-text" value="{{ old('password') }}">
                        @error('password')
                        <div class="text-red-500">
                            {{ $message }}
                        </div>
